...
func NewTransactionOrchestrator(transactionService domain.TransactionService, positionService domain.PositionService, uow domain.UnitOfWork) *TransactionOrchestrator {
...
func (o *TransactionOrchestrator) AddTransactionWithPosition(transaction *domain.Transaction) (*domain.Transaction, *domain.Position, error) {
